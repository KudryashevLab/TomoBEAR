                            ...
                            if obj.configuration.aligned_stack_binning > 1
                                ...
                                if end_steps(j) == 8
                                    ...
                                    if isfield(obj.configuration.tomograms.(field_names{obj.configuration.set_up.j}), "motion_corrected_even_files")
                                        ...
                                        status = system("newstack -InputFile " + even_tilt_stacks{obj.configuration.set_up.adjusted_j}...
                                        ...
                                        status = system("newstack -InputFile " + odd_tilt_stacks{obj.configuration.set_up.adjusted_j}...
