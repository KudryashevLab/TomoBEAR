                ...
                for i = 1:tomogram_counter
                    ...
                    for j = 1:length(end_steps)
                        ...
                        if (end_steps(j) == 6 || end_steps(j) == 8)...
                            ...
                            x_shifts = (point_file_content{1,2} / obj.configuration.pre_aligned_stack_binning)...
                                + (prexg_file_content{1,5}(point_file_content{1,4} + 1) / obj.configuration.pre_aligned_stack_binning);
                            y_shifts = (point_file_content{1,3} / obj.configuration.pre_aligned_stack_binning)...
