        ...
        function obj = process(obj)
            ...
            for i = 1:length(obj.configuration.binnings)
                ...
                if (isinf(obj.configuration.binnings(i)) || floor(obj.configuration.binnings(i)) ~= obj.configuration.binnings(i))...
                    && (isinf(obj.configuration.binnings(i) / obj.configuration.ft_bin)...
                    || (floor(obj.configuration.binnings(i) / obj.configuration.ft_bin) == obj.configuration.binnings(i) / obj.configuration.ft_bin))
...
%                         end
                        ...
                        bin_factor = obj.configuration.binnings(i) / obj.configuration.ft_bin / obj.configuration.aligned_stack_binning;
