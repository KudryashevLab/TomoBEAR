        ...
        function obj = process(obj)
            ...
            for i = 1:length(obj.configuration.binnings)
                ...
                if (isinf(obj.configuration.binnings(i)) || floor(obj.configuration.binnings(i)) ~= obj.configuration.binnings(i))...
                    && (isinf(obj.configuration.binnings(i) / obj.configuration.ft_bin / obj.configuration.aligned_stack_binning)...
                    || (floor(obj.configuration.binnings(i) / obj.configuration.ft_bin / obj.configuration.aligned_stack_binning) == obj.configuration.binnings(i) / obj.configuration.ft_bin / obj.configuration.aligned_stack_binning))
                    disp("WARNING: skipping binning for factor " + obj.configuration.binnings(i) + " because integer check was not passed!");
                    continue;
                end
                if obj.configuration.use_ctf_corrected_aligned_stack == true && (obj.configuration.binnings(i) / obj.configuration.ft_bin / obj.configuration.aligned_stack_binning) < 1
...
%                         end
                        ...
                        bin_factor = obj.configuration.binnings(i) / (obj.configuration.aligned_stack_binning / obj.configuration.ft_bin);
...
%                     for j = 1:length(obj.configuration.binnings)
                        ...
                        executeCommand("newstack"...
                            ...
                            + " -antialias " + obj.configuration.antialias_filter...
                            + " -bin " + num2str(obj.configuration.binnings(i) / obj.configuration.ft_bin), false, obj.log_file_id);
                        ...
                        if obj.configuration.run_ctf_phaseflip == true
                            ...
                            command = "ctfphaseflip -input " + stack_output_path...
                                ...
                                + " -maxWidth " + height...
                                + " -pixelSize " + (apix * obj.configuration.binnings(i)) / 10 ...
