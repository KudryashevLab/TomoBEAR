    ...
    methods
        ...
        function obj = process(obj)
            ...
            for i = 1:length(obj.configuration.binnings)
                ...
                if obj.configuration.binnings(i) == obj.configuration.aligned_stack_binning && ~isfield(obj.configuration.tomograms.(field_names{obj.configuration.set_up.j}), "motion_corrected_even_files") && ~isfield(obj.configuration.tomograms.(field_names{obj.configuration.set_up.j}), "motion_corrected_dose_weighted_files") && ~isfield(obj.configuration.tomograms.(field_names{obj.configuration.set_up.j}), "motion_corrected_dose_sum_weighted_files")                    disp("INFO: skipping binning for factor " + obj.configuration.binnings(i) + " because it is the same as was generated by BatchRunTomo module!");
                    continue;
                end
