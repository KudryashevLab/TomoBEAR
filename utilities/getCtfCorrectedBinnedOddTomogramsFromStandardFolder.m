...
function binned_tomograms = getCtfCorrectedBinnedOddTomogramsFromStandardFolder(configuration, flatten, binning)
if nargin == 1
    flatten = false;
    binning = 0;
elseif nargin == 2
...
if isfield(configuration, "ctf_corrected_binned_odd_tomograms_folder") && flatten == true
    binned_tomograms_path = configuration.processing_path...
        + string(filesep) + configuration.output_folder + string(filesep)...
        + configuration.ctf_corrected_binned_odd_tomograms_folder...
...
elseif isfield(configuration, "ctf_corrected_binned_odd_tomograms_folder") && flatten == false
    binned_tomograms_path = configuration.processing_path...
        + string(filesep) + configuration.output_folder + string(filesep)...
        + configuration.ctf_corrected_binned_odd_tomograms_folder;
