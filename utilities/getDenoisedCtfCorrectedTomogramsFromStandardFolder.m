...
function binned_tomograms = getDenoisedCtfCorrectedBinnedTomogramsFromStandardFolder(configuration, flatten)
if nargin == 1
    flatten = false;
end

if isfield(configuration, "denoised_ctf_corrected_tomograms_folder") && flatten == true
    binned_tomograms_path = configuration.processing_path...
        + string(filesep) + configuration.output_folder + string(filesep)...
        + configuration.denoised_ctf_corrected_tomograms_folder...
...
elseif isfield(configuration, "denoised_ctf_corrected_tomograms_folder") && flatten == false
    binned_tomograms_path = configuration.processing_path...
        + string(filesep) + configuration.output_folder + string(filesep)...
        + configuration.denoised_ctf_corrected_tomograms_folder;
