...
if isfield(configuration, "apix")
    rescaled_pixelsize = configuration.apix * configuration.ft_bin * scaling_binning_factor;
    apix = configuration.apix;
elseif isfield(configuration, "greatest_apix")
    rescaled_pixelsize = configuration.greatest_apix  * configuration.ft_bin * scaling_binning_factor;
    apix = configuration.greatest_apix;
elseif isfield(configuration, "smallest_apix")
    rescaled_pixelsize = configuration.smallest_apix * configuration.ft_bin * scaling_binning_factor;
