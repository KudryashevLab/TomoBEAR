function tilt_stacks = getCtfCorrectedAlignedTiltStacksFromStandardFolder(configuration, flatten)
...
if isfield(configuration, "ctf_corrected_aligned_tilt_stacks_folder") && flatten == true
    tilt_stack_path = configuration.processing_path + string(filesep) + configuration.output_folder + string(filesep)...
        + configuration.ctf_corrected_aligned_tilt_stacks_folder + string(filesep) + "**" + string(filesep) + "*.ali";
    tilt_stacks = dir(tilt_stack_path);
elseif isfield(configuration, "ctf_corrected_aligned_tilt_stacks_folder") && flatten == false
    tilt_stack_path = configuration.processing_path + string(filesep) + configuration.output_folder + string(filesep) + configuration.ctf_corrected_aligned_tilt_stacks_folder;
